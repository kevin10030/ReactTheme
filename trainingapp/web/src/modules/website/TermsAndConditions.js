...
import terms_and_conditions from "../../assets/images/home/terms_and_conditions.png"
...
export default function TermsAndConditions() {
  ...
  return (
    <div className={classes1.container} style={{width:"100%",padding:"0",margin:"0"}}>
      <div style={{backgroundImage: "url("+terms_and_conditions+")",backgroundRepeat:'no-repeat',  backgroundPosition: 'center', backgroundSize: 'cover'}}>
        <CRow className="justify-content-center" style={{margin:"0"}}>
          <Hidden smDown>
            <spin style={{paddingTop:"7rem",paddingBottom:"7rem", fontFamily:"Poppins-Bold", fontSize:"270%", color:"#fff"}}>{'Terms and conditions'}</spin>
          </Hidden>
          <Hidden mdUp>
            <spin style={{paddingTop:"5rem",textAlign:"center",paddingLeft:"2rem",paddingRight:"2rem", paddingBottom:"5rem", fontFamily:"Poppins-Bold", fontSize:"230%", color:"#fff"}}>{'Terms and conditions'}</spin>
          </Hidden>
        </CRow>
      </div>
