...
__webpack_require__.d(__webpack_exports__, "CPopover", function() { return /* reexport */ src_tooltip_CPopover; });
...
var CBreadcrumbRouter_CBreadcrumbRouter = function CBreadcrumbRouter(props) {
  ...
  if (routes) {
    ...
    var currRoutes = routes.filter(function (route) {
...
var CModal_Context = external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createContext({}); //component - CoreUI / CModal
...
var CModal_CModal = function CModal(props) {
  ...
  var modalClasses = classnames_default()('modal overflow-auto', (_classNames = {}, _classNames["modal-" + color] = color, _classNames));
  ...
  return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement("div", {
    onClick: modalClick
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(fade_CFade, CModal_extends({}, transitionProps, {
    "in": Boolean(isOpen),
    onEntered: onEntered,
    onExited: onExited,
    tabIndex: "-1",
  ...
  }, props.children)))), backdrop && isOpen && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement("div", {
...
var CDataTable_CDataTable = function CDataTable(props) {
  ...
  var headerStyles = function headerStyles(index) {
    ...
    if (fields && fields[index] && fields[index]._style) {
      return CDataTable_extends({}, style, fields[index]._style);
    }
  ...
  var columnFilterEvent = function columnFilterEvent(colName, value, type) {
    ...
    var newState = CDataTable_extends({}, columnFilterState, (_extends2 = {}, _extends2["" + colName] = value, _extends2));
  ...
  })))))), footer && currentItems.length > 0 && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement("tfoot", null, headerContent), captionSlot), loading && (loadingSlot || /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(element_cover_CElementCover, {
    boundaries: [{
      sides: ['top'],
      query: 'td'
    }, {
...
// EXTERNAL MODULE: ./node_modules/tippy.js/dist/border.css
var dist_border = __webpack_require__(17);

// EXTERNAL MODULE: ./src/tooltip/CPopover.css
var tooltip_CPopover = __webpack_require__(18);
...
var CPopover_CPopover = function CPopover(props) {
  ...
  var advancedOptions = CPopover_extends({}, config ? config.advancedOptions || {} : {}, {
    theme: 'cpopover'
  });

  var computedConfig = CPopover_extends({}, config, {
...
/* harmony default export */ var src_tooltip_CPopover = (CPopover_CPopover);
