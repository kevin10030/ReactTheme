...
To use `Slider`, please refer to the [Slider API](https://docs.cocos.com/creator/3.0/api/en/classes/ui.slider.html) documentation and the [slider](https://github.com/cocos-creator/test-cases-3d/tree/master/assets/cases/ui/10.slider) scene of the test-cases-3d project.
