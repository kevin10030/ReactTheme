...
相关 TiledTile 脚本接口请参考 [TiledTile API](https://docs.cocos.com/creator/3.0/api/zh/classes/TiledTile.html)
...
Layer 脚本接口相关请参考 [TiledLayer API](https://docs.cocos.com/creator/3.0/api/zh/classes/TiledLayer.html)
