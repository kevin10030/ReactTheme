...
For the related interface of the spherical light component, please refer to the [SphereLight API](https://docs.cocos.com/creator/3.0/api/en/classes/component_light.spherelight.html).
