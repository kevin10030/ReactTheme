...
For more information about **VideoPlayer**'s scripting interface, please refer to the [VideoPlayer API](https://docs.cocos.com/creator/3.0/api/en/classes/video.videoplayer.html) documentation.
...
| **Video Player Event**   | The video player's callback, it will be triggered when certain event occurs. Please refer to the `VideoPlayer Event` section below or [VideoPlayerEvent API](https://docs.cocos.com/creator/3.0/api/en/classes/video.videoplayer.html#videoplayerevent) for more details. |
...
Please refer to the [VideoPlayer API](https://docs.cocos.com/creator/3.0/api/en/classes/video.videoplayer.html) documentation for details on **VideoPlayer** events.
